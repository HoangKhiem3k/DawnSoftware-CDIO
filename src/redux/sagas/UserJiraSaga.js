...
import { ADD_USER_PROJECT_API, DISPLAY_LOADING, GET_LIST_PROJECT_SAGA, GET_USER_API, GET_USER_BY_PROJECT_ID, GET_USER_BY_PROJECT_ID_SAGA, GET_USER_SEARCH, HIDE_LOADING, REMOVE_USER_PROJECT_API, STATUS_CODE, TOKEN, USER_LOGIN, USER_SIGNIN_API, USLOGIN ,USER_SIGNUP_API} from "../../util/constants/settingSystem";
...
function * signupSaga(action) {
    ...
    //Gọi api
    try{
        const {data,status} = yield call(() =>jiraService.signupDawn(action.userRegister))
